...
from .views import (AddPost, PostDetail, EditPost, DeletePost, UserPostList,
                    TagsView, UpvoteView, DownvoteView, EditProfile,
                    DeleteComment, EditComment, UserDraftList,
                    EditDraft, SearchPosts, ShowProfileView)

urlpatterns = [
    path('', views.PostList.as_view(), name='home'),
    path('user-posts/<str:username>', views.UserPostList.as_view(),
         name='user_posts'),
    path('user-draft/<str:username>', views.UserDraftList.as_view(),
         name='user_drafts'),
    path('edit-draft/<slug:slug>', EditDraft.as_view(), name="edit_draft"),
    path('account/edit-profile/<str:username>', EditProfile,
         name="edit_profile"),
    ...
    path('<slug:slug>/<int:comment_post>/delete', DeleteComment,
         name='delete_comment'),
    path('<slug:slug>/<int:comment_post>/edit', EditComment,
         name='edit_comment'),
